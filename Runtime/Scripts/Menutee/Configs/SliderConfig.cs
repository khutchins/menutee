...
namespace Menutee {
	public class SliderConfig : PanelObjectConfig {
		...
		public class Builder : BaseSliderBuilder<SliderConfig, Builder> {
			...
			public Builder(GameObject prefab, float minValue, float maxValue, float defaultValue) : base(prefab, minValue, maxValue) {
				_defaultValue = defaultValue;
			}
    ...
    public abstract class BaseSliderBuilder<TConfig, TBuilder> : PanelObjectConfig.Builder<TConfig, TBuilder>
        ...
        public BaseSliderBuilder(GameObject prefab, float minValue, float maxValue)
            : base(prefab) {
            _minValue = minValue;
            _maxValue = maxValue;
        }
